...
class Link(Base):
    ...
    source_id: Mapped[str] = mapped_column(String, ForeignKey("components.id", ondelete="CASCADE"))
    target_id: Mapped[str] = mapped_column(String, ForeignKey("components.id", ondelete="CASCADE"))
